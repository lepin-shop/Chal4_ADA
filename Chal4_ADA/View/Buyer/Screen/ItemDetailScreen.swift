        ...
        var body: some View {
                ...
                VStack(spacing: 0) {
                    ...
                    ScrollView {
                        VStack(alignment: .leading, spacing: 16) {
                            ...
                            // 2. Molecule: Gallery
                            ImageGalleryCarousel(imageUrl: item.mediaUrl, grade: String(describing: item.qualityGrade))
                            ...
                            DetailHeaderInfo(title: item.title, price: item.pricePerUnit, stock: item.quantity)
            ...
            .sheet(isPresented: $showSheet) {
                DynamicSheet(
                    ...
                    item: item,
                    onConfirm: { activeSheetMode = .qrCode }
                )
                .presentationDetents(
